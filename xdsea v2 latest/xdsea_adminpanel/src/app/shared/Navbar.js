        ...
        provider.enable().
          then(async (accounts) => {
            ...
            //  var respval = await AddressUserDetails_GetOrSave_Call(currAddr);
              ...
              toast.warning("Please Connect to Ethereum Network", config.toasterOption);
            }
          })
          .catch((e) => { })
      }
          ...
          <ul className="navbar-nav navbar-nav-right">
           {(!Wallet_Details.UserAccountAddr)?
                <div className="navbar-profile">
                  <button className="mb-0 d-none d-sm-block navbar-profile-name" onClick={()=>setIsOpen(true)} ><Trans>connect Wallet</Trans></button>
                </div>:
...
<Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
  ...
  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}  className="preview-item">
    ...
    <div className="preview-item-content">
      <button  onClick={Disconnect} className="preview-subject mb-1"><Trans>Disconnect</Trans></button>
    </div>
  </Dropdown.Item>
  <Dropdown.Divider />
</Dropdown.Menu>
...
<Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
  ...
  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}  className="preview-item">
    ...
    <div className="preview-item-content">
      <button  onClick={()=>logout()} className="preview-subject mb-1"><Trans>Log out</Trans></button>
    </div>
  </Dropdown.Item>
  <Dropdown.Divider />
</Dropdown.Menu>
     ...
     <Modal 
      ...
      >
        ...
        {window && (window.ethereum) && <>
          ...
          <div>
          <button onClick={()=>getinit('mt')}>Metamask</button>
          </div>}
