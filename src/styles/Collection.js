      ...
      <ZStack>
        ...
        <ZItem>
          ...
          >
            ...
            <TitleBold21 display={"-webkit-box"} overflow={"hidden"} clamp={"1"} orient={"vertical"}>{collectionName || "Collection Name"}</TitleBold21>
            <BodyRegular display={"-webkit-box"} overflow={"hidden"} clamp={"1"} orient={"vertical"} align="center" textcolor={appStyle.colors.white}>
