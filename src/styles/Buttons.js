    ...
    >
      {btnStatus === 1 ? 
        func === "Mint" ? (
          ...
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Placing Offer</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "Withdraw" ? (
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Withdrawing Listing</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "Edit" ? (
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Editing Listing</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "List" ? (
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Listing NFT</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "Transfer" ? (
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Transferring</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "WithdrawOffer" ? (
          <HStack spacing="6px">
            <BodyRegular textcolor={appStyle.colors.white}>Withdrawing Offer</BodyRegular>
            <RingSpinner size={21} color={appStyle.colors.white} loading={true} />
          </HStack>
        ) : func === "AcceptOffer" ? (
          <HStack spacing="6px">
      ...
      : btnStatus === 2 ? (
        ...
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>Offer Placed</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "Withdraw" ? (
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>Listing Withdrawn</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "Edit" ? (
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>Listing Edited</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "List" ? (
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>NFT Listed</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "Transfer" ? (
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>NFT Transferred</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "WithdrawOffer" ? (
        <HStack spacing="6px">
          <BodyRegular textcolor={appStyle.colors.white}>Offer Withdrawn</BodyRegular>
          <IconImg url={successIcon} width="21px" height="21px"></IconImg>
        </HStack>
      ) : func === "AcceptOffer" ? (
        <HStack spacing="6px">
      ...
      : (
        <>
          {hasImage ? (
            ...
            <BodyBold cursor={btnStatus === -1 ? "default" : "pointer"} textcolor={textcolor}>{text}</BodyBold>
          )}
        </>
      )}
    </ButtonView>
