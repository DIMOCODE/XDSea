 ...
 * 
 * @param {string} searchTerm search word to filter Collections
 ...
 * @param {string} sortBy sorting criteria for Collections - "relevance", "publication", "volumeTrade", 
 *                  "owners", "floorPrice", "nfts", "alphabetical"
 ...
 * @param {string} sortBy sorting criteria for NFTs of the collection - "relevance", "publication", "price", 
 *                          "offersAmount", "alphabetical"
 * @param {number} sortDirection sorting direction i.e., 1 for least to greatest, -1 for greatest to least
 ...
 * 
 * @param {string} name name of the collection
 * @returns HTTP GET request response with a boolean to indicate if the collection exists and the DB Collection object if it
 *            does
 */
